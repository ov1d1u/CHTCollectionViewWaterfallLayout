...
This fork is intended for internal use and you probably don't want to use it. Forked because overriding `[CHTCollectionViewWaterfallLayout prepareLayout]` was not a solution.
